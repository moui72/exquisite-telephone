...
describe('composeVersionString', () => {
  ...
  it('shows vX.Y.Z-dev on dev', () => {
    expect(composeVersionString({ version: '1.2.3', channel: 'dev' })).toBe('v1.2.3-dev');
  });

  it('treats an absent or unrecognized channel as dev', () => {
