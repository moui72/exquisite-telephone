...
Why: dealing from a shuffled fixed set guarantees no phrase appears to more than one player in a game, and curated phrases lower the blank-page burden for players who struggle to invent a prompt.
