...
- [x] T016 [artifacts: infrastructure, constitution] Add structured log events for room creation, join/leave/reconnect, turn advance, and game completion (Observability), including outcome and reproducible identifiers.
...
- [x] T019 [artifacts: ui] [parallel] Add the per-book save control in the Reveal view wired to the export pipeline.
